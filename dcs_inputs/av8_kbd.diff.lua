local diff = {
	["keyDiffs"] = {
		...
		["d499pnilunilcdnilvdnilvpnilvunil"] = {
			["name"] = "HUD Altitude Selector",
			["removed"] = {
				[1] = {
					["key"] = "Num5",
					["reformers"] = {
		...
		["d61pnilunilcdnilvdnilvpnilvunil"] = {
		...
		["d630pnilunilcdnilvd1vpnilvunil"] = {
			["name"] = "Change Mission Route Map Page",
			["removed"] = {
				[1] = {
					["key"] = "Space",
					["reformers"] = {
